...
return credito;}
	...
	/* (non-Javadoc)
	 * @see etsisi.ems.trabajo3.banco.Tarjeta#setCuenta(etsisi.ems.trabajo3.banco.Cuenta)
	 */
	...
	/* (non-Javadoc)
	 * @see etsisi.ems.trabajo3.banco.Tarjeta#retirar(double)
	 */
	...
	//traspaso tarjeta a cuenta
		/* (non-Javadoc)
		 * @see etsisi.ems.trabajo3.banco.Tarjeta#ingresar(double)
		 */
	...
	/* (non-Javadoc)
	 * @see etsisi.ems.trabajo3.banco.Tarjeta#pagoEnEstablecimiento(java.lang.String, double)
	 */
	...
	/* (non-Javadoc)
	 * @see etsisi.ems.trabajo3.banco.Tarjeta#getSaldo()
	 */
